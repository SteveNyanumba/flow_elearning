            ...
            <div class="row">
              <div class="col-10">
                ...
                <div class="mb-3">
                  ...
                  <input
                    type="text"
                    v-model="editcourse.abbreviation"
                    class="form-control"
              ...
              <div class="mb-3">
                ...
                <select v-model="editcourse.course_type" class="form-control">
              ...
              <div class="mb-3">
                ...
                <select v-model="editcourse.faculty" class="form-control">
...
export default {
  ...
  data() {
    return {
      editcourse: {
        ...
        course_type: this.course.type_id,
        faculty: this.course.faculty_id,
      },
    };
  },
  ...
  methods: {
    updateCourse() {
      console.log("clicked");
      this.$inertia.put(`/admin/courses/${this.course.id}`, this.editcourse);
    },
  },
};
</script>
