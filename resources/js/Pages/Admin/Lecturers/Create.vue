      ...
      <div class="col-4">
        <div class="card shadow">
          <div class="card-title">
            <h3 class="text-center m-2">Add New Lecturer</h3>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-10">
                <div class="mb-3">
                  <label for="name" class="form-label">Lecturers's Name</label>
                  <input
                    type="text"
                  ...
                  <small id="name" class="form-text text-muted"
                    >Full Name of the Lecturer</small
                  >
                  <div
...
export default {
  ...
  methods: {
    newLecturer() {
      console.log("clicked");
      this.$inertia.post("/admin/lecturers", this.lecturer);
    },
  },
};
</script>
