      ...
      <div class="col-md-10 col-12">
        <div class="card shadow">
          <div class="card-header">
            <h2 class="card-title">Administrators' List</h2>
            <inertia-link
          ...
          <div class="card-body table-responsive p-0" style="height: 600px">
            ...
            >
              ...
              <tbody>
                <tr v-for="admin in admins" :key="admin.id" class="odd">
                  ...
                  <td>
                    <div class="row justify-content-center">
                      ...
                      <div class="col-4 m-1">
                        <button class="btn-secondary btn" @click="deleteAdmin(admin.id)">
...
export default {
  ...
  methods: {
    deleteAdmin(id) {
      this.$inertia.delete("/admin/admins/" + id);
    },
  },
  mounted() {
